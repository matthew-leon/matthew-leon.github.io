...
On the programming side, I was satisfied with the sound of the sonAqua. The percussive sounds make for an interesting performance, and I enjoyed learning how to sample different parts of the instrument to make new timbres. In the patch I might tweak the fading between repetitions of samples. Jumping from the end of the sample to the beginning rapidly causes a small dropout click, which is not very pleasing. Instead, I would add a small fade between the beginning and the end of the sample for a more satisfying sample playback.
...
Here are some pictures of me setting up and performing: 
